...
public final class Constants {
    ...
    public final static class DrivetrainConstants{
       ...
       public static final double TURN_SPEED_MULT = 1;
        ...
        //Math LOL Constants
        public static final double SLEW_RATE_DRIVE_POSITIVE = 3;
        public static final double SLEW_RATE_DRIVE_NEGATIVE = -3;
        public static final double SLEW_RATE_TURN_POSITIVE = 3;
        public static final double SLEW_RATE_TURN_NEGATIVE = -3;
